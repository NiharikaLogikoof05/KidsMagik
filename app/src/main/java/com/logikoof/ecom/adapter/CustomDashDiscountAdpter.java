 ...
 */
public class CustomDashDiscountAdpter extends RecyclerView.Adapter<CustomDashDiscountAdpter.MyViewHolder> {
    ...
    public CustomDashDiscountAdpter(Context context,List<String> tasklist) {
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
            ...
            if (listPosition==1) {
                holder.productname.setText("Jet Pen 8");
                holder.product.setBackgroundResource(R.drawable.pensss);

            }
            if (listPosition==2) {
                holder.productname.setText("Chirtmas Card");
                holder.product.setBackgroundResource(R.drawable.cards);
